...
module.exports = {
    ...
    run: async(client, message, args) => {
        ...
        .setColor("#933fd6")
        .setDescription(`${message.author} Insira o canal para qual o anuncio será enviado`);
        ...
        .setColor("#933fd6")
        .setDescription(`${message.author} Insira o Título do Anuncio`);

        let embed_3 = new Discord.MessageEmbed()
        .setColor("#933fd6")
        .setDescription(`${message.author} Insira a Descrição do Anuncio`);
                            ...
                            let titulo = palavra_2.content;
                             ...
                             message.reply({ embeds: [embed_3] }).then(m_3 => {
                                ...
                                coletor_3.on("collect", (palavra_3) => {
                                    ...
                                    message.reply(`Seu anuncio foi enviado para ${chat} com sucesso!`).then(m => {
                                        chat.send({ embeds: [
